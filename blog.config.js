...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Alan Chang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Cloud Native is Eating the World', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://alanblog.zeabur.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'changyinyucyy@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  PRISM_THEME_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-atom-dark.min.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
